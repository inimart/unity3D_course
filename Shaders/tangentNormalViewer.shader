...
Shader "Custom/_tangentNormalViewer"
{
	Properties
	{
		...
		[KeywordEnum(Tangent,World)] _NormalSpace("Normal space", Float) = 0
	}
	Subshader
	{
		...
		Pass
		{
			...
			#pragma shader_feature _NORMALSPACE_TANGENT _NORMALSPACE_WORLD
			...
			half4 frag(vertexOutput o):COLOR
			{
				...
				*/
				...
				#if _NORMALSPACE_TANGENT
					half4 finalColor = float4(TSNormal, 1);
				#endif
				#if _NORMALSPACE_WORLD
